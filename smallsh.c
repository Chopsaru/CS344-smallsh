...
** 	Author: Greg Noetzel
** 	Date: 8/26/2020
** 	Description: A basic unix shell that supports commands: exit, cd, and status.
				Other commands spawn child processes, can run jobs in bg by appending
				"$" to command. All instances of "$$" extended to shell pid
	SYNTAX  :[arg1 arg2 ...] [< input_file] [> output_file] [&]
*************************************************************************************/
